...
DELETE FROM Carts;
DBCC CHECKIDENT ('EshopAPI.dbo.Carts', RESEED, 0);
GO
DELETE FROM InvoiceDetails;
DBCC CHECKIDENT ('EshopAPI.dbo.InvoiceDetails', RESEED, 0);
GO
DELETE FROM Invoices;
DBCC CHECKIDENT ('EshopAPI.dbo.Invoices', RESEED, 0);
GO
DELETE FROM Accounts;
DBCC CHECKIDENT ('EshopAPI.dbo.Accounts', RESEED, 0);
GO
DELETE FROM Products;
DBCC CHECKIDENT ('EshopAPI.dbo.Products', RESEED, 0);
GO
DELETE FROM ProductTypes;
DBCC CHECKIDENT ('EshopAPI.dbo.ProductTypes', RESEED, 0);
GO
